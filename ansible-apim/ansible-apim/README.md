...
1. [WSO2 API Manager 4.5.0 package (.zip)](https://wso2.com/api-management/install/)

Copy the following files to `files/lib` directory.

1. [OpenJDK21U-jdk_x64_linux_hotspot_21.0.8_9 (.tar.gz)](https://adoptium.net/es/temurin/releases?arch=x64&package=jre&version=21&os=linux)
...
```
[apim]
ansible_host=172.28.128.4 ansible_user=ansible
...
#### Ansible resources for API Manager 4.5.0 and higher.
